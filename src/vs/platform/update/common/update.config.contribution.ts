...
configurationRegistry.registerConfiguration({
	...
	properties: {
		'update.mode': {
			...
			description: localize('updateMode', "Configure whether you receive automatic updates. Requires a restart after change. The updates are fetched from the project's GitHub releases."),
			...
			policy: {
				...
				minimumVersion: '1.67',
				localization: {
					description: { key: 'updateMode', value: localize('updateMode', "Configure whether you receive automatic updates. Requires a restart after change. The updates are fetched from the project's GitHub releases."), },
					enumDescriptions: [
						{
							key: 'none',
		...
		'update.showReleaseNotes': {
			...
			default: true,
			scope: ConfigurationScope.APPLICATION,
			description: localize('showReleaseNotes', "Show Release Notes after an update. The Release Notes are fetched from the project's GitHub releases."),
			tags: ['usesOnlineServices'],
